...
public class Editor {
    ...
    public static String addTable(String msg) {
        String colorMsg = "<table style=\"height: 108px;\" border=\"1\" width=\"487\">\n"
                ...
                + "<h1><span style=\"color: #ff0000;\"><a title=\"Click v&agrave;o đ&acirc;y để trở về trang ch&iacute;nh\" href=\"http://abc.com/\">http://abc.com/</a></span></h1>\n"
                + "</td>\n"
                + "</tr>\n"
                + "<tr>\n"
                + "<td style=\"text-align: center;\" colspan=\"2\">\n"
                ...
                + "<tr>\n"
                + "<td style=\"text-align: center;\" colspan=\"2\">\n"
                + "<h2><span style=\"color: #ff0000;\">Cảm ơn bạn đ&atilde; xem thư n&agrave;y!</span><img src=\"https://lh4.googleusercontent.com/proxy/tfkQ53gpD3wFwSVgTY6FcCH2MVBhyJp-rKUsY0w4S0MoHGW9cPj6AP1hJMq5cVSRE9IUO8UfLxBG2YvW6Q=s0-d\" alt=\"abc.com\" width=\"460\" height=\"306\" /></h2>\n"
                + "</td>\n"
                + "</tr>\n"
                + "</tbody>\n"
                + "</table>";
     ...
     public static String Contact(String msg) {
        String colorMsg = "<table style=\"height: 108px;\" border=\"1\" width=\"487\">\n"
                + "<tbody>\n"
                + "<tr>\n"
                + "<td style=\"text-align: center;\" colspan=\"2\">\n"
                ...
                + "<tr>\n"
                + "<td style=\"text-align: center;\" colspan=\"2\">\n"
                + "<h2>&nbsp;&nbsp;Thông tin l&agrave;:&nbsp;<span style=\"text-decoration: underline; color: #3366ff;\">" + msg + "</span></h2>\n"
                + "</td>\n"
                + "</tr>\n"
                + "<tr>\n"
                + "<td style=\"text-align: center;\" colspan=\"2\">\n"
